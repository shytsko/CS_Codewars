...
Console.WriteLine(num.DigitalRoot(999999999999));

public class Number
{
    public int DigitalRoot(long n) => (n < 10) ? (int)n : DigitalRoot(SumDigit(n));

    public int SumDigit(long n) => (n < 10) ? (int)n : (int)(n % 10 + SumDigit(n / 10));
}